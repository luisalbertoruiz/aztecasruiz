				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<a href="javascript:;" onclick="eliminaRegistro('{{URL::to('/admin/cancha/'.$cancha->id)}}','{{$cancha->id}}');" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="top" data-original-title="eliminar"><i class="glyphicon glyphicon-trash"></i></a>
							{{ Form::open(array('method' => 'DELETE', 'route' => array('admin.cancha.destroy', $cancha->id),'id'=>$cancha->id)) }}{{ Form::close() }}
							</td>
						</tr>
					@endforeach
					</tbody>
